    ...
    */
    ...
    public:
        ...
        */
        ...
        [[nodiscard]] Type getType() const override { return Layer::Type::Tile; }
        ...
        \see getChunks()
        */
        [[nodiscard]] const std::vector<Tile>& getTiles() const { return m_tiles; }
        ...
        \see getTiles()
        */
        [[nodiscard]] const std::vector<Chunk>& getChunks() const { return m_chunks; }
