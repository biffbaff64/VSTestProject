...
namespace tmx
{
    ...
    */
    struct TMXLITE_EXPORT_API Version
    {
        ...
        explicit Version(std::uint16_t maj = 0, std::uint16_t min = 0)
            : upper(maj), lower(min)
        {
        }
    };
    ...
    */
    ...
    public:
        ...
        [[nodiscard]] int getMapWidth();
        [[nodiscard]] int getMapHeight();
        ...
        */
        [[nodiscard]] const Vector2u &getTileCount() const
        {
            return m_tileCount;
        }
        ...
        */
        [[nodiscard]] const Vector2u &getTileSize() const
        {
            return m_tileSize;
        }
        ...
        */
        ...
        {
            return FloatRect(0.f, 0.f, static_cast<float>(m_tileCount.x * m_tileSize.x),
        ...
        returns 0.f
        */
        [[nodiscard]] float getHexSideLength() const
        {
        ...
        */
        [[nodiscard]] StaggerAxis getStaggerAxis() const
        {
        ...
        */
        [[nodiscard]] StaggerIndex getStaggerIndex() const
        {
        ...
        */
        [[nodiscard]] const Colour &getBackgroundColour() const
        {
        ...
        */
        ...
        \see Layer
        */
        [[nodiscard]] const std::vector<Layer::Ptr> &getLayers() const
        {
            return m_layers;
        }
        ...
        */
        [[nodiscard]] const std::map<std::uint32_t, Tileset::Tile> &getAnimatedTiles() const
        {
            return m_animTiles;
        }
        ...
        */
        [[nodiscard]] const std::string &getWorkingDirectory() const
        {
        ...
        */
        std::unordered_map<std::string, MapObject> &getTemplateObjects()
        {
            return m_templateObjects;
        }

        [[nodiscard]] const std::unordered_map<std::string, MapObject> &getTemplateObjects() const
        {
            return m_templateObjects;
        }
        ...
        If MapObject::getTilesetName() is not Empty it can be used to retreive a tileset
        ...
        */
        ...
        [[nodiscard]] const std::unordered_map<std::string, Tileset> &getTemplateTilesets() const
        {
            return m_templateTilesets;
        }
    ...
    private:
        ...
        std::unordered_map<std::string, MapObject>  m_templateObjects;
